(function(r,f){if(typeof define === 'function' && define.amd){define(['bean','underscore'],function(bean, _){return (r.Flotr=f(bean, _));});}else{r.Flotr=f(r.bean,r._);}}(this,function(bean, _){
/**
